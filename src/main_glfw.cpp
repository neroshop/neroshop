...
int main(int, char**) // dokun-ui uses glsl version 330, opengl 3.3+
{
    // Setup window
...
#if defined(NEROSHOP_OPENGL_ES2)
    // GL ES 2.0 + GLSL 100
    ...
    GLFWwindow* window = glfwCreateWindow(1280, 720, "neroshop", NULL, NULL);
    if (window == NULL)
        return 1;
    ...
    label->set_string("Welcome to dokun-ui in the neroshop application");
    ...
    Vector4f clear_color = Vector4f(32 / 255.0, 32 / 255.0, 32 / 255.0, 1.00f);//(0.45f, 0.55f, 0.60f, 1.00f);
